...
/**
 * Servlet implementation class DisplayPlayer3Buildings
 */
@WebServlet("/DisplayPlayer3Buildings")
public class DisplayPlayer3Buildings extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayPlayer3Buildings() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ourgame.getPlayerc().setShowBuildings(true);
