...
/**
 * Servlet implementation class DisplayPlayer2Buildings
 */
@WebServlet("/DisplayPlayer2Buildings")
public class DisplayPlayer2Buildings extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayPlayer2Buildings() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ourgame.getPlayerb().setShowBuildings(true);
