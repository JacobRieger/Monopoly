...
/**
 * Servlet implementation class DisplayPlayer4Buildings
 */
@WebServlet("/DisplayPlayer4Buildings")
public class DisplayPlayer4Buildings extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayPlayer4Buildings() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ourgame.getPlayerd().setShowBuildings(true);
